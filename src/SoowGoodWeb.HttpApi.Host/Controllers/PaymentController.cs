            ...
            try
            {
                ...
                if (continueWithValidationCheck)
                {
                    ...
                    if ((bool)validationResult.IsValidTransaction)
                    {
                        ...
                        var appointmentInfo = _appointmentService.GlobalAppointmentResponse;
                        //await _appointmentService.UpdateAppointmentPaymentStatusAsync()
                    }
                    else
                    {
                ...
                else
                {
                    ...
                    await _sslCommerzAppService.UpdateApplicantPaymentStatus(sslCommerzResponseDic);
                    var response12 = await _sslCommerzAppService.GetAppointmentCode(sslCommerzResponseDic);
                    var sentNotification = await _appointmentService.UpdateAppointmentStatusAfterPaymentAsync(response12, 1);
                }

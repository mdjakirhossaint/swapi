...
namespace SoowGoodWeb.Enums
{
    ...
    public enum FeeManagementType
    {
        InstantOnlineDoctorAppointment = 1,
        InstantOnlineDoctorAppointment_Agent = 2,
        ScheduledChamberDoctoAppointment_Cash = 3,
        AllSelectedDoctorFeeByAgentMaster = 4,
        IndividualDoctorFeeselectedbyAgentMaster = 5,
        AllSelectedDoctorFeeforCampaign = 6,
        IndividualDoctorFeeselectedforCampaign = 7
    }

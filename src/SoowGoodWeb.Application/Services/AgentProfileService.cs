...
IRepository<AgentMaster> agentMasterRepository)
        {
        ...
        public async Task<List<AgentProfileDto>> GetListAsync()
        {
            ...
            try
            {
                ...
                if (item.Any())
                {
                    ...
                    {
                        var agentMaster = await _agentMasterRepository.GetAsync(x => x.Id == profile.AgentMasterId);
                        ...
                        result.Add(new AgentProfileDto()
                        {
                            ...
                            AgentMasterName = agentMaster?.AgentMasterOrgName,
        ...
        public async Task<List<AgentProfileDto>> GetAgentListFilterByAdminAsync(DataFilterModel? agentFilterModel, FilterModel filterModel)
        {
            ...
            try
            {
                ...
                if (agentFilterModel?.isActive != null)
                {
                    ...
                    {
                        profiles = profiles.Where(p => p.IsActive == false || !p.IsActive.HasValue).ToList();
                    }
                }
                foreach (var item in profiles)
                {
                    result.Add(new AgentProfileDto()
                    {
                        ...
                        AgentMasterName = item?.AgentMaster?.AgentMasterOrgName,
